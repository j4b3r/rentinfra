...
Run the SQL migrations in `supabase/migrations/` against your Supabase project (in order, `001` → `005`, then `007`–`009`) via the Supabase SQL editor or CLI. Skip `006_demo_seed.sql` — it only contains fake data for the public demo.
