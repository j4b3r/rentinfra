    ...
    <div className="min-h-screen bg-[#F8F9FA] flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 w-full max-w-md p-8">
        <div className="text-center mb-6">
          ...
          <p className="text-gray-500 text-sm mt-1">Sign in to your RentInfra account</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button type="submit" disabled={loading}
            className="w-full bg-[#0A1F44] text-white py-3 rounded-lg font-semibold hover:bg-[#C9A84C] hover:text-[#0A1F44] transition-colors disabled:opacity-60">
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          ...
          <Link href="/auth/register" className="text-[#C9A84C] font-semibold hover:underline">Register</Link>
        </p>
      </div>
    </div>
  )
